...
public class WorkflowStatusDisplayContextTest {
	...
	public void testGetStatus() {
		...
		_setAttribute(WorkflowStatusWebKeys.STATUS, mockHttpServletRequest, 1);

		Assert.assertEquals(
			Integer.valueOf(2),
			_workflowStatusDisplayContext.getStatus(mockHttpServletRequest));

		_setAttribute(WorkflowStatusWebKeys.BEAN, mockHttpServletRequest, null);
	...
	public void testGetStatusMessage() {
		...
		_setAttribute(
			WorkflowStatusWebKeys.STATUS_MESSAGE, mockHttpServletRequest,
			"Status Message");

		_setAttribute(WorkflowStatusWebKeys.STATUS, mockHttpServletRequest, 2);
