...
import InstanceInfos from '../../../src/main/resources/META-INF/resources/workflow_status/js/components/instance-infos/InstanceInfos';

describe('The InstanceInfos component should', () => {
	let type, value;
	...
	it('render with ID type', () => {
		...
		const {getByText} = render(<InstanceInfos type={type} value={value} />);
