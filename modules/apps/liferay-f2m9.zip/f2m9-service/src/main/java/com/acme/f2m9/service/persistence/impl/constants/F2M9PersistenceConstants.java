...
package com.acme.f2m9.service.persistence.impl.constants;
...
public class F2M9PersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "com.acme.f2m9.service";
